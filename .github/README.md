...
- **Versions (1.15, 1.18, etc)**
  These are the main branches where development for LTS can be found. These branches are stopped at the last patch version of their indicated minor version, and will receive periodic updates as outlined in the wiki above.
